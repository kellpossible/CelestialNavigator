...
/*! @defgroup networkInterface Network Interface Plug-in
@{
...
NetworkInterface takes this idea and extends it to add markings every few
...
class NetworkInterface : public StelModule
{
	Q_OBJECT
	Q_PROPERTY(bool marksVisible READ getNetworkInterface WRITE setNetworkInterface NOTIFY networkInterfaceChanged)
public:
	NetworkInterface();
	...
	//! Settings are kept in the "NetworkInterface" section in Stellarium's
...
public slots:
	...
	bool getNetworkInterface() const {return markFader;}
	...
	void setNetworkInterface(bool b);	

signals:
	void networkInterfaceChanged(bool);
...
private:
    ...
    NetworkInterfaceUDPThread* udpThread;
    double currentLocation = 39.819000;
};
...
class NetworkInterfaceStelPluginInterface : public QObject, public StelPluginInterface
{
	Q_OBJECT
